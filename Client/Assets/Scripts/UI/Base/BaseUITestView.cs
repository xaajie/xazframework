...
public class BaseUITestView : UIView
{
	...
	protected Cell GetCellView(UITableView tableView, UITableViewCell tableCell)
	{
		object cell = null;
	...
	protected class TV_List
	{
		...
		static public Cell Get(UITableViewCell tableCell)
		{
			Cell cell = null;
